// Page content component for Privacy page
            ...
            <div className="bg-white p-8 rounded-lg shadow-md border border-cleaning-border">
              ...
              <div className="space-y-6 text-cleaning-text/80">
                <div>
                  ...
                  <p className="mt-3">
                    This information may include your name, phone number, email address, postcode, and details about your requirements.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    <li>Provide services and quotes</li>
