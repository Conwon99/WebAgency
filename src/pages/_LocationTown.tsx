  ...
  return (
    <div className="font-inter">
      <Helmet>
        ...
        <link rel="canonical" href={`https://codapixel.com/locations/${town?.toLowerCase()}`} />
        ...
        <meta property="og:url" content={`https://codapixel.com/locations/${town?.toLowerCase()}`} />
            ...
            itemListElement: (
              ayrshireTowns.has(townName || '')
                ? [
                    ...
                    { '@type': 'ListItem', position: 3, name: 'Ayrshire', item: 'https://codapixel.com/locations/ayrshire' },
                    { '@type': 'ListItem', position: 4, name: townName || 'Town', item: `https://codapixel.com/locations/${town?.toLowerCase()}` }
                  ]
                : [
                    { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://codapixel.com/' },
                    { '@type': 'ListItem', position: 2, name: 'Locations', item: 'https://codapixel.com/locations' },
                    { '@type': 'ListItem', position: 3, name: townName || 'Town', item: `https://codapixel.com/locations/${town?.toLowerCase()}` }
                  ]
            )
          })}
        </script>
